...
//                        超过一定次数(15) 或者超出一定时间 就把这个事务消息抛弃了(72 * 3600 * 1000)
...
//                        检查是否需要回查 消息存储时间是否超出transactionTimeout
                        boolean isNeedCheck =
...
//                            回查
     ...
     *
     * @param removeMap mHalf message to be reove, key:halfOffset, value: opOffset.
